...
public partial class ValuationSendLetter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sFileName;
        sFileName = Server.MapPath("~/PDfs/a.pdf");

        fpath = Server.MapPath("~/Reports/valuationsendletter.rpt");
        ...
        //    string progname = "ValuationSendLetter.aspx";
